          ...
          <div className="hero-context">
            <div className="content-self">
              <div className="INTRO">
                ...
                <p>
                  HI I'm Udhaya Prakash, a passionate UI Web Developer bassed in
                  the india. welcome to portfolio world.
                </p>
                <button className="btn-intro">About Me</button>
              </div>
